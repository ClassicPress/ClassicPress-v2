...
?>
		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="site-info">
				...
				?>
				<a href="<?php echo esc_url( __( 'https://www.classicpress.net/', 'classicpress-twentysixteen' ) ); ?>" class="imprint">
					<?php printf( __( 'Proudly powered by %s', 'classicpress-twentysixteen' ), 'ClassicPress' ); ?>
				</a>
			</div><!-- .site-info -->
		</footer><!-- .site-footer -->
	</div><!-- .site-inner -->
