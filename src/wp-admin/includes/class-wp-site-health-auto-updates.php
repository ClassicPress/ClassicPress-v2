<?php
/**
 * Class for testing automatic updates in the ClassicPress code.
 *
	...
	public function test_accepts_dev_updates() {
		...
		if ( defined( 'WP_AUTO_UPDATE_CORE' ) && ( 'minor' === WP_AUTO_UPDATE_CORE || false === WP_AUTO_UPDATE_CORE ) ) {
			return array(
				'description' => sprintf(
					...
					__( 'ClassicPress development updates are blocked by the %s constant.' ),
		...
		if ( ! apply_filters( 'allow_dev_auto_core_updates', $wp_version ) ) {
			return array(
				'description' => sprintf(
					/* translators: %s: Name of the filter used. */
					__( 'ClassicPress development updates are blocked by the %s filter.' ),
	...
	public function test_accepts_minor_updates() {
		if ( defined( 'WP_AUTO_UPDATE_CORE' ) && false === WP_AUTO_UPDATE_CORE ) {
			return array(
				'description' => sprintf(
					/* translators: %s: Name of the constant used. */
					__( 'ClassicPress security and maintenance releases are blocked by %s.' ),
		...
		if ( ! apply_filters( 'allow_minor_auto_core_updates', true ) ) {
			return array(
				'description' => sprintf(
					/* translators: %s: Name of the filter used. */
					__( 'ClassicPress security and maintenance releases are blocked by the %s filter.' ),
