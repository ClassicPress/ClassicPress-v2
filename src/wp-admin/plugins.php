	...
	array(
		...
		'content' =>
				...
				'<p>' . sprintf(
					...
					__( 'If something goes wrong with a plugin and you cannot use ClassicPress, delete or rename that file in the %s directory and it will be automatically deactivated.' ),
	...
	get_current_screen()->add_help_tab(
		array(
			...
			'content' =>
					...
					'<p>' . __( 'Auto-updates are only available for plugins recognized by ClassicPress.org, or that include a compatible update system.' ) . '</p>' .
